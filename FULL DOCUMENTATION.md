...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/data-your/TESTING-119.git
  ls
  cd TESTING-119
...
```bash
git config --global user.email "gyrogodngghggon@gmail.com"
git config --global user.name "data-your119"
